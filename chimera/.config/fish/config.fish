...
abbr gpof "git push --origin main --force"
abbr gl   "git pull"
...
abbr -a gmm "set -l b (git branch --show-current); git push origin \$b; git checkout main; git merge \$b; git push origin main; git push origin --delete \$b; git branch -d \$b"
